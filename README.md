...
*Supports selective scanning: `aws-doctor waste ec2 s3 elb cloudwatch rds`*
...
- **🧟 Zombie Discovery:** Scans for idle EIPs, stopped instances, orphaned snapshots, idle RDS instances, idle NAT Gateways, idle load balancers, and more. Supports selective service filtering (`ec2`, `s3`, `elb`, `cloudwatch`, `rds`, `vpc`).
